                    ...
                    <Modal v-if="showModal" @close="showModal = false">
                        ...
                        <template v-slot:body>
                            <div class="flex items-center justify-center">
                                <Icon name="material-symbols:question-mark-rounded" size="100"
                                    class="border-2 border-primary rounded-full p-5 text-primary"></Icon>
                            </div>
                        ...
                        <template v-slot:footer>
                            <div class="flex justify-end gap-3">
                                ...
                                <button class="bg-red-500 px-4 py-1 text-white rounded-md"
                                ...
                                <tr v-for="cart in carts" :key="cart.id">
                                    ...
                                    <td class="border border-slate-300 font-light">
                                        <div class="flex justify-center">
                                            <button
                                                ...
                                                @click="changeQty(cart.product_id, 'min')"> - </button>
                                            <input type="number" v-model="cart.qty"
                                            ...
                                            <button
                                                ...
                                                @click="changeQty(cart.product_id, 'plus')"> + </button>
                                        </div>
                                    </td>
                                    <td class="border border-slate-300 font-light tracking-wider">
                                        ${{ cart.total }}
                                    ...
                                    <td class="border border-slate-300 font-light">
                                        <button
                                            ...
                                            @click="openModal(cart._id)">X</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div v-else>
                        <div class="flex flex-col justify-center items-center py-10">
                            ...
                            <button
                                ...
                                @click="$router.push('/shop')">Go to Shop</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-between mt-14" v-if="carts.length !== 0">
                    <div class="w-[50%]">
                        <div class="flex w-full gap-12">
                            <button
                                ...
                                @click="updateCarts()">Update Cart</button>
                            <button
                                ...
                                @click="$router.push('/shop')">Continue Shopping</button>
                        </div>
                        <div class="flex flex-col gap-4 mt-10">
                            ...
                            <div class="flex w-full gap-5">
                                ...
                                <button
                                    class="w-[40%] uppercase tracking-wider text-white bg-primary hover:bg-secondary transition-all duration-150 hover:shadow-2xl hover:-translate-y-0.5 text-sm font-light py-3 rounded-md">Apply
                                    Coupon</button>
                            </div>
                        </div>
                    </div>
                    <div class="w-[30%]">
                        ...
                        <div class="w-full mt-10">
                            <button
                                class="w-full uppercase tracking-wider text-white bg-primary hover:bg-secondary transition-all duration-150 hover:shadow-2xl hover:-translate-y-0.5 text-md font-light py-5 rounded-md">Proceed
                                To Checkout</button>
                        </div>
                    </div>
                </div>
