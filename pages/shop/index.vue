...
const title1: string = `${year} Nuxt3.js`
                    ...
                    <div class="flex flex-col gap-4 w-[20%]">
                        ...
                        <div class="border border-slate-300 py-4 px-5 flex flex-col gap-8">
                            <div>
                                ...
                                <div class="mt-5">
                                    <Slider v-model="sliderValue" :min="0" :max="500" :tooltips="true" :showTooltip="'drag'"
                                        :tooltipPosition="'top'" />
                                    <p class="mt-4 font-light text-[0.9rem] tracking-wider"><span>${{ sliderValue[0] }} -
                                            ${{ sliderValue[1] }}</span></p>
                                </div>
                            </div>
                            <div>
                                <p class="uppercase text-base font-normal tracking-wider">Size</p>
                                <div class="mt-1">
                                    <input type="checkbox"> <span class="font-light text-gray-600 text-sm ml-2">Small
                                        (1,239)</span>
                                </div>
                                <div class="mt-1">
                                    <input type="checkbox"> <span class="font-light text-gray-600 text-sm ml-2">Medium
                                        (1,239)</span>
                                </div>
                                <div class="mt-1">
                                    <input type="checkbox"> <span class="font-light text-gray-600 text-sm ml-2">Large
                                        (1,239)</span>
                                </div>
                                <div class="mt-1">
                                    <input type="checkbox"> <span class="font-light text-gray-600 text-sm ml-2">Extra Large
                                        (1,239)</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-[80%]">
                        <div class="flex justify-between">
                            ...
                            <div class="flex gap-4">
                                <div>
                                    <button
                                        class="px-4 py-3 rounded-sm bg-gray-btn font-light text-sm tracking-wider uppercase hover:-translate-y-1 transition-all duration-300 hover:shadow-md hover:shadow-slate-700">
                                        Latest
                        ...
                        <div class="mt-16">
                            <div class="grid grid-cols-3 gap-7">
                                <div v-for="product in products" :key="product._id"
                                    class="border border-gray-btn shadow-md hover:cursor-pointer"
                                    ...
                                    <div class="py-5 text-center flex justify-center items-center flex-col gap-1">
                                        ...
                                        <p class="text-sm font-light text-gray-500 tracking-wide">{{ product.short_desc }}
                                        </p>
                            ...
                            <div class="flex items-center justify-center mt-14">
                                <vue-awesome-paginate :total-items="50" :items-per-page="10" :max-pages-shown="5"
